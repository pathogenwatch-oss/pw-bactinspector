...
codes = pandas.read_csv('raw_data/taxon_codes.csv', header=0, dtype=str, index_col=0)
names = pandas.read_csv('raw_data/taxon_names.csv', header=0, dtype=str, index_col=0)
